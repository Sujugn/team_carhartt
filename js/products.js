...
const NEW = [
  {
    ...
    recentPrice: "",
    description:
      "S/S WYNTON SHIRT는 면100% 'COOSA' 립스탑 소재의 반팔 셔츠입니다. 레귤러 핏이며, 두개의 가슴 포켓은 플랩과 벨크로로 여닫을 수 있습니다. 후면에는 슬릿 디테일이 있으며, 정면 가슴 포켓에는 스퀘어 라벨이 부착되어 있습니다.",
  },

  {
    ...
    recentPrice: "",
    description:
      "WYNTON SHORT는 면100% 'COOSA' 립스탑 소재의 카고 반바지입니다. 릴렉스트 핏에 밑위는 레귤러 웨이스트입니다. . 허리 밴드는 신축성이 있으며, 조절식 벨트가 있습니다. 지퍼 플라이 형식입니다. 후면과 측면의 포켓은 플랩과 벨크로로 여닫을 수 있습니다. ",
  },
...

  {
    ...
    recentPrice: "",
    description:
      "ROUND CARABINER는 아연 합금 소재의 카라비너입니다. 사이즈는 지름 5 CM로, 둥근 형태의 카라비너 입니다. 그래픽이 음각으로 새겨져 있습니다.",
  },

  {
    ...
    recentPrice: "",
    description:
      "BAYFIELD BUCKET HAT은 오가닉 코튼100% ;DEARBORN' 캔버스 소재의 버킷햇입니다. 안감이 있으며, 정면에 스퀘어 라벨이 부착되어 있습니다.",
  },

  {
    ...
    recentPrice: "",
    description:
      "BAYFIELD TOTE SMALL은 오가닉 코튼100% 'DEARBORN' 캔버스 소재의 토트백입니다. 36 X 34 X 12 CM 크기로 14.6 리터의 수납이 가능합니다. 안감이 없고, 스냅으로 여닫을 수 있습니다. 내부에 지퍼가 달린 포켓이 있으며, 정면에는 스퀘어 라벨이 부착된 포켓이 있습니다.",
  },

  {
    ...
    recentPrice: "",
    description:
      "W S/S LOVILIA SHIRT는 면100% 'PERRY' 데님 소재의 반팔 셔츠입니다. 루즈 핏이며, 가슴 포켓에 스퀘어 라벨이 부착되어 있습니다.",
  },
  {
    id: "new_08",
    ...
    recentPrice: "",
    description:
      "W ALMA PANT는 면100% 'PERRY' 데님 소재의 워크 팬츠입니다. 루즈 테이퍼드 핏에 밑위는 하이 웨이스트입니다. 데님과 립스탑 소재가 믹스되어 있는 디테일이 있습니다. 무릎 부분은 패치로 덧대여져 있습니다. 지퍼 플라이 형식이며, 제품 측면에는 툴 포켓, 해머 루프가 있습니다. 후면 포켓에는 스퀘어 라벨이 부착되어 있습니다. ",
  },
]; //main_page NEW
